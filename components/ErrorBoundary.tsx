...
// Fix: Switched to class property state initialization to resolve errors where `this.state` and `this.props` were not found on the component instance. This is a more modern and concise syntax.
